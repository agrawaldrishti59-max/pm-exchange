  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100vh" }}>
      ...
      <div style={{ flex: 1, padding: 16, overflowY: "auto" }}>
        ...
        {notifs.map(n => (
          <div key={n.id} style={{ background: n.is_read ? "#fff" : "#F8F9FF", border: "1px solid #eee", borderRadius: 12, padding: 14, marginBottom: 8, borderLeft: n.is_read ? "1px solid #eee" : "3px solid #185FA5" }}>
